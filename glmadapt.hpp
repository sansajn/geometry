...
template <typename T, glm::precision P>
struct coordinate_type<glm::detail::tvec2<T, P>>
{
	typedef typename glm::detail::tvec2<T, P>::value_type type;
};

template <typename T, glm::precision P>
struct coordinate_system<glm::detail::tvec2<T, P>>
{
	typedef cs::cartesian type;
};

template <typename T, glm::precision P>
struct dimension<glm::detail::tvec2<T, P>> : boost::mpl::int_<2>
{};

template <typename T, glm::precision P, std::size_t Dimension>
struct access<glm::detail::tvec2<T, P>, Dimension>
{
	typedef glm::detail::tvec2<T, P> point_type;
